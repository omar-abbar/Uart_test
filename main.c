...
/*uint8_t PCF8591_Adc(uint8_t chaanel,uint8_t mode)
{
        uint8_t ContReg;
        ContReg &=0b01000100; // clear all except flags
        ContReg|= (mode << 4);
        ContReg|= chaanel;
//        select SLAVE_ADDRESS to transfer
        I2CMasterSlaveAddrSet(I2C0_BASE, SLAVE_ADDRESS, false);
//        put data to I2C data register
        I2CMasterDataPut(I2C0_BASE, ContReg);
...
//
        ...
        I2CMasterControl(I2C0_BASE, I2C_MASTER_CMD_SINGLE_RECEIVE);*/
         ContReg=0x44;
        //PCF8591_Adc(0,0);
        I2CReceiveMultipleBytes(SLAVE_ADDRESS,ContReg, 1, (uint8_t *)&ui32DataTx);
